...
const AI_SPECIALIZATIONS: Record<string, Specialization> = {
  ...
  mitsu: {
    ...
    negativeInstruction:
      "ステップ1は最大2ターン。ステップ2は2ターンに分割（2-1: 書のことば引用『』で囲む、2-2: 問いかけ）。必ずRAGから具体的な言葉を引用（つまづいたっていいじゃないか/トマトがねえ/過ぎたことは/しあわせは自分の心が等）。ステップ2で小さな一歩を提案しない。ステップ3で3分でできる行動を提案。『感情ラベル』禁止。一般化禁止。命令形禁止。『RAGによると』禁止。",
    provider: "openai",
    model: "gpt-4o",
  },
  kenji: {

                ...
                {messages.map((message) => {
                  ...
                  return (
                    <div key={message.id} className="flex gap-3">
                      ...
                      <div
                        className={cn(
                          "max-w-[85%] rounded-3xl px-4 py-3 leading-relaxed shadow",
...
const DALE_CONFIG: ChatConfig = {
  ...
  theme: {
    ...
    assistantText: "text-slate-900 text-base",
    assistantBorder: "border-2 border-slate-300",
    activeBackground: "bg-gradient-to-r from-[#0ea5e9] via-[#2563eb] to-[#1d4ed8]",
    newChatButton:
      "bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 focus-visible:ring-blue-200 shadow-blue-400/40",
    headingText: "text-slate-900",
    headerSubtitle: "text-blue-600",
    headerDescription: "text-slate-700",
    badgeBackground: "bg-blue-50",
    badgeText: "text-blue-900",
    badgeHintText: "text-blue-700",
    statsBadgeBackground: "bg-blue-50",
    statsBadgeText: "text-blue-900",
    sectionBorder: "border-slate-200",
    promptBorder: "border-slate-300",
    promptText: "text-slate-700",
    promptHoverBorder: "hover:border-blue-400",
    detailBorder: "border-slate-300",
    detailBackground: "bg-slate-50",
    ...
    inputText: "text-slate-900 text-base",
    skeletonBorder: "border-slate-300",
    skeletonHighlight: "#e2e8f0",
    skeletonShade: "#f8fafc",
    deleteButtonText: "text-slate-700",
    deleteButtonHover: "hover:bg-slate-100",
  },
  initialPrompts: [
    "最悪を想像して受け入れる方法を知りたい",
...
const HOSHI_CONFIG: ChatConfig = {
  ...
  hero: {
    name: "ホシ",
    subtitle: "星の旅カウンセリング",
    description: "小さな星の旅の気づきで、見えない大切なものを思い出させます",
    iconUrl: "/images/counselors/hoshi.png",
  },
  theme: {
    gradientFrom: "#fff7ed",
    gradientVia: "#fef3c7",
    ...
    bubbleAssistant: "bg-[#fffaf0]",
    assistantText: "text-[#3f2d1c]",
    assistantBorder: "border border-amber-100",
    activeBackground: "bg-gradient-to-r from-[#f59e0b] via-[#fbbf24] to-[#d97706]",
    newChatButton:
      "bg-gradient-to-r from-[#f59e0b] via-[#fbbf24] to-[#d97706] focus-visible:ring-amber-200 shadow-amber-300/50",
    headingText: "text-[#78350f]",
    headerSubtitle: "text-[#f59e0b]",
    headerDescription: "text-[#3f2d1c]",
    badgeBackground: "bg-[#fef3c7]",
    badgeText: "text-[#78350f]",
    badgeHintText: "text-[#3f2d1c]",
    statsBadgeBackground: "bg-[#fffaf0]",
    statsBadgeText: "text-[#78350f]",
    sectionBorder: "border-amber-50",
    promptBorder: "border-amber-100",
    promptText: "text-[#3f2d1c]",
    promptHoverBorder: "hover:border-amber-300",
    detailBorder: "border-amber-100",
    detailBackground: "bg-[#fffaf0]",
    detailText: "text-[#3f2d1c]",
    emptyBorder: "border-amber-100",
    emptyText: "text-[#78350f]",
    inputBorder: "border-amber-100 focus:border-amber-300 focus:ring-amber-100",
    inputBg: "bg-white",
    inputPlaceholder: "placeholder:text-amber-300",
    skeletonBorder: "border-amber-50",

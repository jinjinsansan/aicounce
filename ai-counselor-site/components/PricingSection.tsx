                ...
                <div className="relative p-6 sm:p-8">
                  ...
                  {plan.name === "フリー" ? (
                    <Link
                      ...
                      className="group/btn relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-full bg-[#06C755] px-6 py-4 text-base font-bold text-white shadow-2xl shadow-green-500/40 transition-all hover:bg-[#05b34c] hover:shadow-[0_20px_50px_rgba(6,199,85,0.4)] hover:-translate-y-1 active:translate-y-0"
                    >
                      <svg
                      ...
                      <span className="absolute right-5 text-lg opacity-0 transition-all group-hover/btn:opacity-100 group-hover/btn:right-4">
                        →
                      </span>
                    </Link>
                  ) : (

...
export default function CounselorCard({ counselor, onSelect }: CounselorCardProps) {
  ...
  return (
    <div className="group flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition-all duration-300 sm:rounded-3xl sm:border-slate-100 sm:p-6 hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">

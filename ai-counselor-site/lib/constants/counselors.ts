...
export const FALLBACK_COUNSELORS: Counselor[] = [
  ...
  },
  {
    id: "kenji",
    name: "ケンジ",
    specialty: "銀河ことばカウンセリング",
    description: "夜空の物語のような静かな比喩で、悩みに寄り添い、小さな一歩を示します。",
    iconUrl: "/images/counselors/kenji.png",
    modelType: "openai",
    modelName: "gpt-4o",
    ragEnabled: true,
    systemPrompt: COUNSELOR_SYSTEM_PROMPTS.kenji,
    tags: ["静かな比喩", "銀河", "受容", "一歩"],
    responseTime: "即時",
    sessionCount: 0,
    teamOnly: true,
  ...
  },
  {
    id: "muu",
    name: "ムウ",
    specialty: "北欧メッセージカウンセリング",
    description: "森と自由を愛する穏やかな友人として、名言チャンクをもとに優しく伴走します。",
    iconUrl: "/images/counselors/muu.png",
    modelType: "openai",
    modelName: "gpt-4o",
    ragEnabled: true,
    systemPrompt: COUNSELOR_SYSTEM_PROMPTS.muu,
    tags: ["北欧", "穏やか", "哲学", "自然"],
    responseTime: "即時",
    sessionCount: 0,
  },
  {
    id: "mitsu",
    name: "ミツ",
    specialty: "書のことばカウンセリング",
    description: "素朴な書のことばで弱さを肯定し、今ここに寄り添う短いメッセージを届けます。",
    iconUrl: "/images/counselors/mitsu.png",
    modelType: "openai",
    modelName: "gpt-4o",
    ragEnabled: true,
    systemPrompt: COUNSELOR_SYSTEM_PROMPTS.mitsu,
  ...
  },
  {
    id: "hoshi",
    name: "ホシ",
    specialty: "星の旅カウンセリング",
    description: "小さな星の旅の気づきで、見えない大切なものを思い出させてくれます。",
    iconUrl: "/images/counselors/hoshi.png",
    modelType: "openai",
    modelName: "gpt-4o",
    ragEnabled: true,
    systemPrompt: COUNSELOR_SYSTEM_PROMPTS.hoshi,
    tags: ["星", "素朴", "大切なもの", "一歩"],
    responseTime: "即時",
    sessionCount: 0,
  },

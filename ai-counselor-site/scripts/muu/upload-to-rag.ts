...
const PARENT_DIR = path.join(ROOT_DIR, "data/muu-rag/chunks/parent");
const CHILD_DIR = path.join(ROOT_DIR, "data/muu-rag/chunks/child");
const COUNSELOR_ID = "muu";
const SOURCE_TYPE = "muu_messages";
...
async function main() {
  ...
  console.log("✅ MUU のRAGデータをSupabaseに登録しました");
}

...
const PARENT_DIR = path.join(ROOT_DIR, "data/yuki-rag/chunks/parent");
const CHILD_DIR = path.join(ROOT_DIR, "data/yuki-rag/chunks/child");
const COUNSELOR_ID = "yuki";
const SOURCE_TYPE = "adler_psychology";
...
async function main() {
  ...
  console.log("✅ YUKI のRAGデータをSupabaseに登録しました");
}

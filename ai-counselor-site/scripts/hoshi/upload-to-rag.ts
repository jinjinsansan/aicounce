...
const PARENT_DIR = path.join(ROOT_DIR, "data/hoshi-rag/chunks/parent");
const CHILD_DIR = path.join(ROOT_DIR, "data/hoshi-rag/chunks/child");
const COUNSELOR_ID = "hoshi";
const SOURCE_TYPE = "hoshi_words";
...
async function main() {
  ...
  console.log("✅ HOSHI のRAGデータをSupabaseに登録しました");
}

...
const PARENT_DIR = path.join(ROOT_DIR, "data/pina-rag/chunks/parent");
const CHILD_DIR = path.join(ROOT_DIR, "data/pina-rag/chunks/child");
const COUNSELOR_ID = "pina";
const SOURCE_TYPE = "pina_quotes";
...
async function main() {
  ...
  console.log("✅ PINA のRAGデータをSupabaseに登録しました");
}

...
const PARENT_DIR = path.join(ROOT_DIR, "data/kenji-rag/chunks/parent");
const CHILD_DIR = path.join(ROOT_DIR, "data/kenji-rag/chunks/child");
const COUNSELOR_ID = "kenji";
const SOURCE_TYPE = "kenji_words";
...
async function main() {
  ...
  console.log("✅ KENJI のRAGデータをSupabaseに登録しました");
}
